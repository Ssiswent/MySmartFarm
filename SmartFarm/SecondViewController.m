...
@interface SecondViewController ()<TYCyclePagerViewDataSource, TYCyclePagerViewDelegate>
...
- (void)viewWillLayoutSubviews {
    ...
    _pagerView.frame = CGRectMake(0, 256, CGRectGetWidth(self.view.frame), 300);
